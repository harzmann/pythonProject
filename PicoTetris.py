...
# PicoTetris.py: customized for educational project by Joerg Harzmann
# extended display output using sprites, x/y geometrics with collision
...
# Size of a single tetromino block in pixels
BLOCK_SIZE = const(12)
...
def tetris_main():
    ...
    # make variables global for r/w
    global last_button, now, n, next_n, lines, score, has_rotated, x, prev_x, y, prev_y
